...
function formRelacion() {
  ...
  html +=
    ...
    '<button type="button" id="btnGenerar" class="btn btn-primary btn-pills btn-block waves-effect waves-themed">Generar la Relación por Movimientos para Proovedor <i class="fal fa-hand-holding-usd"></i></button>';
...
function generaRelacion() {
  ...
  html +=
    ...
    "<th>Peaje</th>" +
    "<th>Movimientos</th>" +
    "<th>Dedicible Administración</th>" +
    "<th>Dedicible Retefuente</th>" +
    "<th>Dedicible Reteica</th>" +
    "<th>Dedicible Anticipo</th>" +
    "<th>Otros Dedicibles</th>" +
    "<th>Total</th>" +
    "<th>Observación</th>" +
  ...
  tablaInforme = $("#tablaInforme").DataTable({
    ...
    destroy: true,
    ajax: {
      url: urlBase + "routes/informesRelacionProovedor/relacionMovimiento",
      type: "POST",
      data: {
        placa: placa,
        contrato: contrato,
    ...
    buttons: [
      {
        ...
        messageTop:
          "Relación para pago a Proovedor por Movimientos de maquinarias",
        title: "Relación por Movimientos Proovedor",
      },
    ],
    columns: [
      { data: "id" },
