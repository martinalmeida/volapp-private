...
function formRelacion() {
  ...
  html +=
    ...
    '<button type="button" id="btnGenerar" class="btn btn-info btn-pills btn-block waves-effect waves-themed">Generar la Relación por Fletes para Proovedor <i class="fal fa-hand-holding-usd"></i></button>';
...
function generaRelacion() {
  ...
  tablaInforme = $("#tablaInforme").DataTable({
    ...
    destroy: true,
    ajax: {
      url: urlBase + "routes/informesRelacionProovedor/relacionFlete",
      type: "POST",
      data: {
        placa: placa,
        contrato: contrato,
    ...
    buttons: [
      {
        ...
        messageTop:
          "Relación para pago a Prooverdores por Fletes de maquinarias",
        title: "Relación por Fletes Proovedor",
      },
    ],
    columns: [
      { data: "id" },
