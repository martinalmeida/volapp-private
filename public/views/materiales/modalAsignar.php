        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Asignar tarifa a contrato
                    <small class="m-0 text-muted">
                        En esta modal puedes gestionar las tarifas para cada contrato a la hora de facturar.
                    </small>
                </h4>
                ...
                <form id="frmRegistroAsignar">
                    <div class="form-row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="number" onKeyPress="if(this.value.length==20)return false;" class="form-control" id="tarifa" name="tarifa" placeholder="Tarifa para este contrato" required>
                        </div>
