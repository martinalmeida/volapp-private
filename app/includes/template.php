                ...
                <div class="page-inner">
                    ...
                    <aside class="page-sidebar">
                        ...
                        <nav id="js-primary-nav" class="primary-nav" role="navigation">
                            <div class="info-card">
                                <img src="<?= $_SESSION['imagenUser']; ?>" class="profile-image rounded-circle">
                                <div class="info-card-text">
                                    ...
                                    <span class="d-inline-block text-truncate text-truncate-sm">@<?= $_SESSION['usuario']; ?></span>
                                </div>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                        <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                            <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                                <span class="mr-2">
                                                    <img src="<?= $_SESSION['imagenUser']; ?>" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                                </span>
                                                <div class="info-card-text">
                                                    <div class="fs-lg text-truncate text-truncate-lg"><?= $_SESSION['usuario']; ?></div>
