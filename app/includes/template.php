...
?>
        ...
        <head>
            ...
            <link href="plugins/fontawesome_4/css/font-awesome.min.css" rel="stylesheet">
            <!-- NProgress -->
            <link href="plugins/nprogress/nprogress.css" rel="stylesheet">
            <!-- iCheck -->
            <link href="plugins/iCheck/skins/flat/green.css" rel="stylesheet">
            <!-- FullCalendar -->
            <link href='plugins/fullcalendar-4.3.1/packages/core/main.min.css' rel='stylesheet'>
            <link href='plugins/fullcalendar-4.3.1/packages/daygrid/main.css' rel='stylesheet'>
            <link href='plugins/fullcalendar-4.3.1/packages/timegrid/main.css' rel='stylesheet'>
            <link href='plugins/fullcalendar-4.3.1/packages/list/main.css' rel='stylesheet'>
            <!-- datatable  -->
            <link rel="stylesheet" href="plugins/datatable/jquery.dataTables.css">
            <link rel="stylesheet" href="plugins/datatable/Responsive/responsive.dataTables.css">
            ...
            <!-- Callendar Bootsrap -->
            <link href="plugins/bootstrap-calendar-master/css/calendar.min.css" rel="stylesheet">
            <!-- pNotify -->
            <link rel="stylesheet" href="plugins/pnotify/pnotify.custom.css">
            <!-- Select2 -->
