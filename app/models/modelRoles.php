            ...
            $data[] = array(
                ...
                "defaultContent" => "
                                    <div class='btn-group'>
                                        ...
                                        <button type='button' class='btn btn-primary text-white' data-toggle='tooltip' data-placement='top' title='Asignar Modulos al Rol' onclick='asignarModulos(" . $row['id'] . ");'>
                                            <i class='fal fa-layer-group'></i>
                                        </button>
                                        <button type='button' class='btn btn-warning text-white' data-toggle='tooltip' data-placement='top' title='Permisos a modulos' onclick='modulosPermisos(" . $row['id'] . ");'>
